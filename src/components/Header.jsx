      ...
      */}
                    <div class=" relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                        <div class="flex px-4 pb-2 pt-5">
                            <button
                                ...
                                type="button" class="relative -m-2 inline-flex items-center justify-center rounded-md p-2 text-gray-400">
            ...
            <header class="relative bg-white">
                                ...
                                <div class="flex h-full space-x-8 ">
                                    ...
                                    <div class="flex">
                                        <div class="relative flex">
                                            ...
                                            <a type="button" class="cursor-pointer flex items-center text-sm font-medium text-gray-700 hover:text-gray-800" aria-expanded="false"
                                                onClick={() => setActiveTab(activeTab == 'women' ? null : 'women')}
                                            >Women</a>
                                        </div>
                ...
                */}
                                        ...
                                        {activeTab == 'women' && <div class="absolute inset-x-0 top-full text-sm text-gray-500">
                                    ...
                                    <div class="flex">
                                        <div class="relative flex">
                                            {/* Item active: "border-indigo-600 text-indigo-600", Item inactive: "border-transparent text-gray-700 hover:text-gray-800" */}
                                            <a type="button"
                                                class="cursor-pointer flex items-center text-sm font-medium text-gray-700 hover:text-gray-800" aria-expanded="false"
                                                onClick={() => setActiveTab(activeTab == 'men' ? null : 'men')}
                                            >Men</a>
                                        </div>
                ...
                */}
                                        {/* MEN */}
                                        {activeTab == 'men' && <div class=" absolute inset-x-0 top-full text-sm text-gray-500 ">
                                            {/* Presentational element used to render the bottom shadow, if we put the shadow on the actual panel it pokes out the top, so we use this shorter element to hide the top of the shadow */}
                                            <div class="absolute inset-0 top-1/2 bg-white shadow" aria-hidden="true"></div>
                            ...
                            <div class="ml-auto flex items-center ">
                                ...
                                <div class="flex lg:ml-6">
                                    <Link to="/shop" > <a href="#" class="p-2 text-gray-400 hover:text-gray-500">
                                ...
                                <div class="ml-4 flow-root lg:ml-6">
                                    <Link to="/order/id_7asd9" >  <a href="#" class="group -m-2 flex items-center p-2">
